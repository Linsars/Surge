...
@modify 奶思修改：理论支持 Qx,Loon,Surge,Egern,ShadowRocket,青龙。Linsar修改：适配egern的await链式调用
@date 2026-04-17 23:55:07

============Egern============
先用script.hub转换下一行这个.js重写成egern的模块
https://raw.githubusercontent.com/fmz200/wool_scripts/main/Scripts/PingMe/PingMeSignin.js
导入转换后的模块到egern

打开 Ping Me app注册登陆，然后签到（egern日志里会有提示获取到内容）

本脚本最底下超时时间设置为90秒，运行本签到脚本，看视频会有40s左右时间，请等待

脚本运行成功后会显示具体签到、看视频等获取的coins及现coins剩余
============QuanX============
[rewrite_local]
